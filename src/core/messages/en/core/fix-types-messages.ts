...
export const MENSAGENS_CLI_CORRECAO_TIPOS = {
  ...
  analiseDetalhadaSalva: `${ICONES_ARQUIVO.arquivo} Detailed analysis saved at: .sensei/fix-types-analise.json`,
  ...
  incertosMais: (qtd: number) => `  ... and ${qtd} more uncertain cases (see .sensei/fix-types-analise.json)`,
