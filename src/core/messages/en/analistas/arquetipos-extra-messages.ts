export const ArquetiposExtraMensagens = {
  ...
  descricaoPersonalizado: 'The Sensei identified a project structure that does not match official archetypes,\nbut you can create a custom archetype to receive optimized suggestions!',
  estruturaDetectada: '📁 Detected structure:',
  arquivosRaiz: '📄 Root files:',
  dicaCriar: '💡 To create your custom archetype, run:',
  comandoCriar: '   sensei diagnosticar --criar-arquetipo',
  explicacaoCriar: 'This will create a \'sensei.repo.arquetipo.json\' file based on the current structure,\nwhich the Sensei will use to offer personalized suggestions while keeping best practices.',
  validacao: {
