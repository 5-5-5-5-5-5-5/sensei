...
export const PadroesUsoMensagens = {
  ...
  requireInTs: "Usage of 'require' in TypeScript file. 优先 'import'.",
  evalUsage: "Usage of 'eval' 检测到. Avoid for security and performance reasons.",
  moduleExportsInTs: "Usage of 'module.exports' or 'exports' in TypeScript file. 优先 'export'.",
  withUsage: "Usage of 'with' 检测到. Avoid for readability and scope reasons.",
