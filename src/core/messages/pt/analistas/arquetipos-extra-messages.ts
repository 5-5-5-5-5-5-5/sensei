export const ArquetiposExtraMensagens = {
  ...
  descricaoPersonalizado: 'O Sensei identificou uma estrutura de projeto que não corresponde a arquétipos oficiais,\nmas você pode criar um arquétipo personalizado para receber sugestões otimizadas!',
  ...
  explicacaoCriar: 'Isso criará um arquivo \'sensei.repo.arquetipo.json\' com base na estrutura atual,\nque o Sensei usará para oferecer sugestões personalizadas mantendo as melhores práticas.',
  validacao: {
