...
import { analyzeTypeUsage , createTypeDefinition , isAnyInGenericFunction, isInStringOrComment, isLegacyOrVendorFile, isTypeScriptContext , validateTypeReplacement } from '../type-safety/index.js';
